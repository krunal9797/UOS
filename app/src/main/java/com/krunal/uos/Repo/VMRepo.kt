...
import com.krunal.uos.network.ApiClient
...
class VMRepo private constructor() {
    companion object {
        private var vmRepo: com.krunal.uos.Repo.VMRepo? = null

        @Synchronized
        fun getInstance(): com.krunal.uos.Repo.VMRepo {
            if (com.krunal.uos.Repo.VMRepo.Companion.vmRepo == null) {
                com.krunal.uos.Repo.VMRepo.Companion.vmRepo = com.krunal.uos.Repo.VMRepo()
            }
            return com.krunal.uos.Repo.VMRepo.Companion.vmRepo!!
        }
    }
